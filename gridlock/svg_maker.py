...
class SVGMaker:
    ...
    def render_board(self, board):
        ...
        placed = set()
        for i in range(64):
            if data[i] != '.' and data[i] not in placed:
                letter = data[i]                
...
if __name__ == "__main__":
    ...
    # board = Board()
    # board.place_piece(resources.PIECES['B'], 1,0,False)
    # board.place_piece(resources.PIECES['C'], 0,1,False)
    # board.place_piece(resources.PIECES['A'], 4,1,False)
    # board.print()
